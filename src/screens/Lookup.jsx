      ...
      <div>
        <div className="mymain">
          ...
          <p className="data">
            ...
            thepeople of usingLorem Ipsum is that it has a more-or-less normal
            distribution of letters, as a opposed to using 'Content
          ...
          {loading ? (
            <div>
              <MoonLoader color="#7b0845" loading={loading} height="40" width="15" className="loading" />
            </div>
        ...
        <div className=".pag">
          <PaginationRounded page={setPage} totalPages={totalPage} />
        </div>
      </div>
    </div>
  );
